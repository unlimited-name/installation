...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${WORK_DIR}/root -Dpython3=ON -Ddavix=OFF -Dminuit2=ON -Droofit=ON ${WORK_DIR}/root-${VERSION_ROOT}
...
cmake -DCMAKE_BUILD_TYPE=Release -DGEANT4_INSTALL_DATA=ON -DCMAKE_INSTALL_PREFIX=${WORK_DIR}/Geant4 -DGEANT4_USE_GDML=ON -DGEANT4_USE_OPENGL_X11=ON -DGEANT4_USE_XM=OFF ${WORK_DIR}/geant4.${VERSION_GEANT4}
make -j12 && make install
...
#sudo cp $HOME/g4py.4.10.05.p01.patch ./
...
#export BOOST_ROOT=${WORK_DIR}/anaconda3
#cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${WORK_DIR}/Geant4 ${WORK_DIR}/geant4.${VERSION_GEANT4}/environments/g4py
#make -j12
